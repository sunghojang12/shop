	...
	<nav id="navbar">
		...
		<ul class="navbar__menu">
			...
			<c:if test="${member != null }">
				...
				<li class="navbar__menu__item"><a href="/board/list">상품 리뷰 게시판</li>
		...
		<div class="content_area">
			<div class="section__container2">
				...
				<script>
					...
					mapOption2 = {
						center : new kakao.maps.LatLng(37.49955074835654, 127.02904906424288), // 지도의 중심좌표
						level : 3
					// 지도의 확대 레벨
					};
					var map2 = new kakao.maps.Map(mapContainer2, mapOption2); // 지도를 생성합니다
					// 마커가 표시될 위치입니다
					var markerPosition = new kakao.maps.LatLng(37.49955074835654, 127.02904906424288);
					// 마커를 생성합니다
